...
public class CampaignServiceTest {
    ...
    void launchCampaign_Success() {
        ...
        when(customerRepository.findAll(org.mockito.ArgumentMatchers.<org.springframework.data.jpa.domain.Specification<Customer>>any(), any(org.springframework.data.domain.Pageable.class)))
